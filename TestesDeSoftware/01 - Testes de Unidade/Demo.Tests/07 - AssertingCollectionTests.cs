...
namespace Demo.Tests
{
    public class AssertingCollectionTests
    {
        ...
        {
            // Arrange & Act
            var funcionario = new Funcionario("Anderson", 10000);
        ...
        [Fact]
        public void Funcionario_Habilidades_JuniorDevePossuir()
        {
            // Arrange & Act
            var funcionario = new Funcionario("Anderson", 10000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Anderson", 1000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Anderson", 15000);
